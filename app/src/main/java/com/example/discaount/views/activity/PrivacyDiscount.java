...
public class PrivacyDiscount extends BaseActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_privacy_discount);
        ...
        if (lang.equals("en")) {
            webView.loadUrl("http://shayoub.com/discount-term/privacy-and-policy-en.html");
        } else {
            webView.loadUrl("http://shayoub.com/discount-term/privacy-and-policy-ar.html");
        }
