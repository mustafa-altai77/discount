...
// ############################## create methods ###################################### //
     ...
     */
    public long createPill(com.example.discaount.local.Pills pill) {
     ...
     */
    public long[] createAlarm(com.example.discaount.local.MedicineAlarm alarm, long pill_id) {
        SQLiteDatabase db = this.getWritableDatabase();
     ...
     */
    public void createHistory(com.example.discaount.History history) {
...
// ############################# get methods ####################################### //
     ...
     */
    public com.example.discaount.local.Pills getPillByName(String pillName) {
        ...
        com.example.discaount.local.Pills pill = new com.example.discaount.local.Pills();
    ...
    public List<Pills> getAllPills() {
        ...
        if (c.moveToFirst()) {
            do {
                com.example.discaount.local.Pills p = new com.example.discaount.local.Pills();
    ...
    public List<MedicineAlarm> getAllAlarmsByPill(String pillName) throws URISyntaxException {
        ...
        if (c.moveToFirst()) {
            do {
                com.example.discaount.local.MedicineAlarm al = new com.example.discaount.local.MedicineAlarm();
     ...
     */
    public com.example.discaount.local.MedicineAlarm getAlarmById(long alarm_id) throws URISyntaxException {
    ...
    private List<MedicineAlarm> combineAlarms(List<MedicineAlarm> dbAlarms) throws URISyntaxException {
        ...
        for (com.example.discaount.local.MedicineAlarm al : dbAlarms) {
            if (timesOfDay.contains(al.getStringTime())) {
                /** Add this db row to alarm object */
                for (com.example.discaount.local.MedicineAlarm ala : combinedAlarms) {
                ...
                com.example.discaount.local.MedicineAlarm newAlarm = new com.example.discaount.local.MedicineAlarm();
    ...
    public List<History> getHistory() {
        ...
        if (c.moveToFirst()) {
            do {
                com.example.discaount.History h = new com.example.discaount.History();
...
// ############################### delete methods##################################### //
    ...
    public void deletePill(String pillName) throws URISyntaxException {
        ...
        for (com.example.discaount.local.MedicineAlarm alarm : pillsAlarms) {
            long id = alarm.getId();
            deleteAlarm(id);
        }
