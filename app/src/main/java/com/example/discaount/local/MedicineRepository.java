...
public class MedicineRepository implements MedicineDataSource {
    ...
    private static com.example.discaount.local.MedicineRepository mInstance = null;
    ...
    public static com.example.discaount.local.MedicineRepository getInstance(MedicineDataSource localDataSource) {
        if (mInstance == null) {
            mInstance = new com.example.discaount.local.MedicineRepository(localDataSource);
        }
        return mInstance;
    }
