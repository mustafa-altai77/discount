...
public class MedicinesLocalDataSource implements MedicineDataSource {
    ...
    @Override
    public void saveMedicine(MedicineAlarm medicineAlarm, com.example.discaount.local.Pills pill) {
    ...
    public boolean medicineExits(String pillName) {
        for (com.example.discaount.local.Pills pill : getPills()) {
    ...
    @Override
    public long savePills(History pills) {
        return 0;
    }

    @Override
    public long savePills(com.example.discaount.local.Pills pills) {
        return savePill(pills);
    }

    @Override
    public void saveToHistory(com.example.discaount.History history) {
    ...
    private long savePill(com.example.discaount.local.Pills pill) {
        long pillId = mDbHelper.createPill(pill);
        pill.setPillId(pillId);
        return pillId;
    }

    private com.example.discaount.local.Pills getPillByName(String pillName) {
    ...
    public void addToHistory(com.example.discaount.History h) {
