...
import com.example.discaount.local.MedicineDataSource;
...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    private static com.example.discaount.FakeMedicineLocalDataSource INSTANCE;
    ...
    public static com.example.discaount.FakeMedicineLocalDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new com.example.discaount.FakeMedicineLocalDataSource();
        }
        return INSTANCE;
    }
