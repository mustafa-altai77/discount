...
public class CartItem {
    ...
    public static DiffUtil.ItemCallback<CartItem> getItemCallback() {
        return itemCallback;
    }
    public static void setItemCallback(DiffUtil.ItemCallback<CartItem> itemCallback) {
        CartItem.itemCallback = itemCallback;
    }
